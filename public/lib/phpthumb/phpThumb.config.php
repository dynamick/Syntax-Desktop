...
$PHPTHUMB_CONFIG['cache_maxage']                         = 86400 * 60; // 60 days
$PHPTHUMB_CONFIG['cache_maxsize']                        = 50 * 1024 * 1024; // 50 Mb
$PHPTHUMB_CONFIG['cache_maxfiles']                       = 1000; // no more than 1000 cached files
