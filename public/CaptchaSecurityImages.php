...
? >
	...
	<form action="form.php" method="post">
		...
		<img src="/admin/public/CaptchaSecurityImages.php?width=100&height=40&character=5" /><br />
...
class CaptchaSecurityImages {
  ...
  //font name
	...
	function CaptchaSecurityImages($width='120',$height='40',$characters='6') {
	  $this->font = $_SERVER["DOCUMENT_ROOT"].$this->path.$this->font;
		...
		$text_color       = imagecolorallocate($image, 80, 100, 160);
