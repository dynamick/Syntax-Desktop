...
insert into `aa_page` values ('50', '479', '480', '57', '8', '', '1010', '1', '', '908', '909', '910', '907');
insert into `aa_page` values ('51', '482', '483', '57', '4', '', '1020', '1', '', '912', '913', '914', '911');
insert into `aa_page` values ('52', '605', '606', '22', '9', '1|2', '90', '1', '', '916', '917', '918', '915');
...
insert into `aa_page` values ('57', '954', '956', '0', '4', '', '1000', '1', '', '957', '958', '959', '955');
...
insert into `aa_services_element` values ('506', '148', 'activated', '9', '', '1', '', '554', '255', '555', '', '', '1', '', '100', '', '');
...
insert into `aa_translation` values ('255', 'Scegli il campo che detterÃ  l\'ordine', '');
...
insert into `aa_translation` values ('259', 'Questo servizio Ã¨ multilingua?', 'Is a multilang service? This field is auto calculated by service-o-matic');
...
insert into `aa_translation` values ('546', 'CittÃ ', 'City');
...
insert into `aa_translation` values ('605', 'Area riservata', 'Private area');
...
insert into `aa_translation` values ('656', 'Messaggio da visualizzare dopo che il form ÃƒÂ¨ stato inviato con successo', 'Messaggio da visualizzare dopo che il form Ã¯Â¿Â½ stato inviato con successo');
...
insert into `aa_translation` values ('915', 'area-riservata', 'private-area');
...
insert into `aa_translation` values ('947', 'Accedi', 'Sign in');
insert into `aa_translation` values ('948', 'Acccedi', 'Login');
insert into `aa_translation` values ('949', 'Registrati', 'Sign up');
insert into `aa_translation` values ('950', 'Inserisci la tua email e ti spediremo le istruzioni necessarie:', 'Enter your email address and we\'ll send you the necessary instructions:');
insert into `aa_translation` values ('951', 'Nuovo utente? Registrati qui', 'New user? Register here');
insert into `aa_translation` values ('952', 'Scrivi la parola che vedi qui sopra', 'Write the word you see above');
insert into `aa_translation` values ('953', 'Salva', 'Save');
insert into `aa_translation` values ('954', 'Pagine di servizio', 'Pagine di servizio');
insert into `aa_translation` values ('955', '', '');
insert into `aa_translation` values ('956', '', '');
insert into `aa_translation` values ('957', '', '');
insert into `aa_translation` values ('958', '', '');
insert into `aa_translation` values ('959', '', '');
insert into `aa_translation` values ('960', 'Benvenuto', 'Welcome');
insert into `aa_translation` values ('961', 'I tuoi dati', 'Yours data');
insert into `aa_translation` values ('962', 'Cambia password', 'Change password');
insert into `aa_translation` values ('963', 'Cambia email', 'Change email');
insert into `aa_translation` values ('964', 'Esci senza salvare', 'Exit without save');
insert into `aa_translation` values ('965', 'Veccchia password', 'Old password');
insert into `aa_translation` values ('966', 'Inserisci la password corrente per poter modificare i dati', 'Enter your current password to apply the change');
insert into `aa_translation` values ('967', 'Inserici la nuova password', 'Insert new password');
insert into `aa_translation` values ('968', 'Conferma la nuova password', 'Confirm new password');
insert into `aa_translation` values ('969', 'Salva', 'Save');
insert into `aa_translation` values ('970', 'Annulla', 'Reset');
insert into `aa_translation` values ('971', 'Nuova email', 'New e-mail');
insert into `aa_translation` values ('972', 'Cambio email', 'E-mail change');
insert into `aa_translation` values ('973', 'Modifica password', 'Password change');
insert into `aa_translation` values ('974', 'Invia', 'Send');
insert into `aa_translation` values ('975', 'Campo obbligatorio', 'Required field');
...
CREATE TABLE `dictionary` (
  ...
  PRIMARY KEY (`id`),
  KEY `label` (`label`)
) ENGINE=InnoDB AUTO_INCREMENT=146 DEFAULT CHARSET=utf8 AUTO_INCREMENT=146;
...
insert into `dictionary` values ('23', 'account_password_confirm', '783');
...
insert into `dictionary` values ('82', 'message_logout', '');
...
insert into `dictionary` values ('99', 'error_email_used', '');
insert into `dictionary` values ('100', 'error_incorrect_old_password', '');
insert into `dictionary` values ('101', 'error_incorrect_password', '');
insert into `dictionary` values ('102', 'error_invalid_email', '');
insert into `dictionary` values ('103', 'error_invalid_input', '');
insert into `dictionary` values ('104', 'error_invalid_token', '');
insert into `dictionary` values ('105', 'error_new_email_failed', '');
insert into `dictionary` values ('106', 'error_password_match', '');
insert into `dictionary` values ('107', 'error_password_update', '');
insert into `dictionary` values ('108', 'error_required_field', '');
insert into `dictionary` values ('109', 'error_unknown_email', '');
insert into `dictionary` values ('110', 'error_unknown_user', '');
insert into `dictionary` values ('111', 'error_active_user', '');
...
insert into `dictionary` values ('121', 'login_submit', '948');
insert into `dictionary` values ('122', 'reg_submit', '949');
insert into `dictionary` values ('123', 'email_recupero_password', '950');
insert into `dictionary` values ('124', 'nuovo_utente', '951');
insert into `dictionary` values ('125', 'captcha', '952');
insert into `dictionary` values ('126', 'salva', '953');
insert into `dictionary` values ('127', 'account_welcome', '960');
insert into `dictionary` values ('128', 'account_dati', '961');
insert into `dictionary` values ('129', 'account_password', '962');
insert into `dictionary` values ('130', 'account_mail', '963');
insert into `dictionary` values ('131', 'account_exit', '964');
insert into `dictionary` values ('133', 'account_old_pwd_hint', '966');
insert into `dictionary` values ('135', 'password_hint', '967');
insert into `dictionary` values ('136', 'vecchia_password', '');
insert into `dictionary` values ('137', 'account_password_confirm_hint', '968');
insert into `dictionary` values ('138', 'conferma_password', '');
insert into `dictionary` values ('139', 'account_save', '969');
insert into `dictionary` values ('140', 'account_reset', '970');
insert into `dictionary` values ('141', 'account_new_email', '971');
insert into `dictionary` values ('142', 'email_change_email_subject', '972');
insert into `dictionary` values ('143', 'email_change_password_subject', '973');
insert into `dictionary` values ('144', 'account_send', '974');
insert into `dictionary` values ('145', 'error_required_field', '975');
