...
insert into `aa_services` values ('2', '26', '', 'fa-user-plus', '27', '2', 'aa_users', '10', '1', '39', '');
...
insert into `aa_services` values ('137', '24', '', 'fa-globe', '25', '2', 'aa_translation', '110', '1', '454', '');
insert into `aa_services` values ('142', '241', '', 'fa-camera', '242', '0', 'album', '130', '1', '-469', '');
insert into `aa_services` values ('143', '252', '', 'fa-picture-o', '253', '0', 'photos', '140', '1', '471', '');
insert into `aa_services` values ('144', '281', '', 'fa-file-image-o', '282', '0', 'media', '150', '1', '-488', '');
insert into `aa_services` values ('145', '301', '', 'fa-tags', '302', '0', 'tags', '160', '1', '490', '');
insert into `aa_services` values ('146', '309', '', 'fa-tag', '310', '0', 'tagged', '170', '1', '492', '');
insert into `aa_services` values ('147', '319', '', 'fa-users', '320', '2', 'groups', '180', '1', '494', '');
insert into `aa_services` values ('148', '327', '', 'fa-user-o', '328', '2', 'users', '190', '1', '508', '');
insert into `aa_services` values ('149', '361', '', 'fa-file-text-o', '362', '0', 'documents', '200', '1', '515', '1');
insert into `aa_services` values ('150', '379', '', 'fa-sitemap', '380', '0', 'categories', '210', '1', '523', '1');
insert into `aa_services` values ('151', '400', '', 'fa-book', '401', '0', 'dictionary', '5', '1', '525', '1');
insert into `aa_services` values ('152', '417', '', 'fa-edit', '418', '0', 'forms', '220', '1', '536', '');
insert into `aa_services` values ('153', '438', '', 'fa-check-square-o', '439', '2', 'form_fields', '240', '1', '547', '1');
insert into `aa_services` values ('154', '460', '', 'fa-columns', '461', '0', 'form_fieldsets', '230', '1', '551', '1');
insert into `aa_services` values ('155', '470', '', 'fa-list', '471', '2', 'field_options', '250', '1', '557', '1');
insert into `aa_services` values ('156', '617', '', 'fa-puzzle-piece', '618', '2', 'aa_element', '0', '1', '569', '');
insert into `aa_services` values ('157', '718', '', 'fa-share-square', '719', '0', 'social_network', '0', '1', '583', '');
