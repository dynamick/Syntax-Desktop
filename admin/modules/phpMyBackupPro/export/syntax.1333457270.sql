...
insert into `aa_lang` values ('1', 'italiano', 'it', 'italy.png', '1', '10');
...
insert into `aa_page` values ('22', '92', '93', '0', '4', '1', '5', '1', '', '833', '834', '835');
...
insert into `aa_page` values ('56', '828', '829', '41', '4', '1', '330', '1', '', '830', '831', '832');
...
insert into `aa_services_element` values ('44', '2', 'lang', '11', '', '1', '', '232', '255', '233', '', 'SELECT * FROM aa_lang', '', '', '55', '', '');
...
insert into `aa_services_element` values ('372', '116', 'template', '11', '', '1', '', '306', '255', '307', '', 'SELECT * FROM aa_template', '', '', '40', '', '');
...
insert into `aa_services_element` values ('397', '116', 'visible', '9', '', '1', '', '308', '255', '309', '', '', '1', '', '50', '', '');
...
insert into `aa_translation` values ('433', '<p>Syntax Desktop vince nella categoria Business il primo concorso italiano per i progetti Open source. Per informazioni visitare il sito www.opensourcecontest.it</p>', 'Syntax Desktop won the first italian contest for the open source projects in the business category. You can read more informations at www.opensourcecontest.it');
...
insert into `aa_translation` values ('606', '', '<p>Please fill all the fields.</p>');
...
insert into `aa_translation` values ('724', 'Nome', 'Nome');
insert into `aa_translation` values ('725', 'Nome', 'Nome');
insert into `aa_translation` values ('726', 'Nome', 'Nome');
insert into `aa_translation` values ('727', 'Nome', 'Nome');
insert into `aa_translation` values ('728', 'Nome', 'Nome');
insert into `aa_translation` values ('729', 'Nome', 'Nome');
insert into `aa_translation` values ('730', 'Nome', 'Nome');
insert into `aa_translation` values ('731', 'Nome', 'Nome');
insert into `aa_translation` values ('732', 'Nome', 'Nome');
insert into `aa_translation` values ('733', 'Nome', 'Nome');
insert into `aa_translation` values ('734', 'Nome', 'Nome');
insert into `aa_translation` values ('735', 'Nome', 'Nome');
insert into `aa_translation` values ('736', 'Nome', 'Nome');
insert into `aa_translation` values ('737', 'Nome', 'Nome');
insert into `aa_translation` values ('738', 'Nome', 'Nome');
insert into `aa_translation` values ('739', 'Nome', 'Nome');
insert into `aa_translation` values ('740', 'Nome', 'Nome');
...
CREATE TABLE `form_fields` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 AUTO_INCREMENT=10;
