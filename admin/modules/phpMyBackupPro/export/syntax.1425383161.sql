...
# backup date and time: 03/03/15 12:46:01
...
insert into `aa_page` values ('58', '976', '978', '57', '15', '', '9090', '1', '', '979', '980', '981', '977');
...
CREATE TABLE `aa_services_element` (
  ...
  PRIMARY KEY (`id`),
  KEY `container` (`container`)
) ENGINE=MyISAM AUTO_INCREMENT=582 DEFAULT CHARSET=utf8 COMMENT='Containers' AUTO_INCREMENT=582;
...
insert into `aa_services_element` values ('580', '148', 'login_attempts', '3', '', '', '', '982', '11', '983', '', '', '', '', '230', '', '');
insert into `aa_services_element` values ('581', '148', 'login_count', '3', '', '', '', '984', '11', '985', '', '', '', '', '240', '', '');
...
insert into `aa_translation` values ('398', 'Intro', 'Intro');
...
insert into `aa_translation` values ('988', 'Input non valido!', 'Invalid input!');
...
insert into `aa_translation` values ('986', 'Logout eseguito correttamente.', 'Logout eseguito correttamente.');
...
insert into `aa_translation` values ('982', 'Tentativi di login', 'Login_attempts');
insert into `aa_translation` values ('983', 'ogin falliti consecutivamente. Un numero alto indica un tentativo di violazione dell\\\'account.', '');
insert into `aa_translation` values ('984', 'Conteggio login', 'Conteggio login');
insert into `aa_translation` values ('985', 'Numero di login riusciti dalla creazione dell\\\'account.', 'Numero di login riusciti dalla creazione dell\\\'account.');
...
insert into `aa_translation` values ('656', 'Messaggio da visualizzare dopo che il form è stato inviato con successo', 'Messaggio da visualizzare dopo che il form è stato inviato con successo');
...
insert into `aa_translation` values ('899', 'intro', 'intro');
...
insert into `aa_translation` values ('948', 'Accedi', 'Login');
...
insert into `aa_translation` values ('991', 'Le due password non coincidono', 'Passwords don\'t match');
insert into `aa_translation` values ('992', 'Impossibile aggiornare la password.', 'Can\'t update password');
insert into `aa_translation` values ('993', 'E-mail non riconosciuta', 'Unknown email');
insert into `aa_translation` values ('994', 'L\'account risulta inesistente.', 'Unknown account');
insert into `aa_translation` values ('995', 'La password non è corretta', 'Incorrect password');
insert into `aa_translation` values ('996', 'La vecchia password non è corretta', 'The old password isn\'t correct');
insert into `aa_translation` values ('997', 'Email già in uso', 'Mail address already in use');
insert into `aa_translation` values ('998', 'L\'account risulta già attivato.', 'This account is already active');
...
insert into `dictionary` values ('99', 'error_email_used', '997');
insert into `dictionary` values ('100', 'error_incorrect_old_password', '996');
insert into `dictionary` values ('101', 'error_incorrect_password', '995');
insert into `dictionary` values ('102', 'error_invalid_email', '987');
insert into `dictionary` values ('103', 'error_invalid_input', '988');
insert into `dictionary` values ('104', 'error_invalid_token', '989');
insert into `dictionary` values ('105', 'error_new_email_failed', '990');
insert into `dictionary` values ('106', 'error_password_match', '991');
insert into `dictionary` values ('107', 'error_password_update', '992');
insert into `dictionary` values ('109', 'error_unknown_email', '993');
insert into `dictionary` values ('110', 'error_unknown_user', '994');
insert into `dictionary` values ('111', 'error_active_user', '998');
...
insert into `dictionary` values ('146', 'message_logout', '986');
