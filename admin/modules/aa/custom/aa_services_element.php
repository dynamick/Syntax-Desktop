    ...
    case "20":
      ...
      for ($i=0; $i<$_SESSION["synNElement"]; $i++) {
        if (isset($_SESSION["synElmName"][$i])) {
          ...
          //key check
          if (isset($_SESSION["synKey"][$i]) and $_SESSION["synKey"][$i]==1)
            $chk = "checked=\"checked\" ";
          else
            $chk = "";

          if (isset($_SESSION["synElmType"][$i]) and $_SESSION["synElmType"][$i]==1/*synKey*/)
            $chk = "checked=\"checked\" onclick=\"this.checked=true;\" ";
          if (isset($_SESSION["synChkKey"][$i]) and $_SESSION["synChkKey"][$i]=="1")
            echo "<td style='border-bottom: 1px solid #F2F2F2; padding-left: 10px;' ><input type=\"hidden\" name=\"synKey[$i]\" value=\"\"/><input type=\"checkbox\" name=\"synKey[$i]\" value=\"1\" title=\"Is key field?\" $chk/></td>\n";
          else
            echo "<td style='border-bottom: 1px solid #F2F2F2; padding-left: 10px;' ><input type=\"checkbox\"   disabled=\"disabled\" /></td>\n";

          //visible check
          if (isset($_SESSION["synVisible"][$i]) and $_SESSION["synVisible"][$i]==1)
            $chk = "checked=\"checked\" ";
          else
            $chk = "";

          if (isset($_SESSION["synChkVisible"][$i]) and $_SESSION["synChkVisible"][$i]=="1")
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"hidden\"  name=\"synVisible[$i]\" value=\"\"/><input type=\"checkbox\"  name=\"synVisible[$i]\" value=\"1\" title=\"Is visible in the index?\" $chk/></td>\n";
          else
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"checkbox\"   disabled=\"disabled\" /></td>\n";

          //editable check
          if (isset($_SESSION["synEditable"][$i]) and $_SESSION["synEditable"][$i]==1)
            $chk = "checked=\"checked\" ";
          else
            $chk = "";

          if (isset($_SESSION["synChkEditable"][$i]) and $_SESSION["synChkEditable"][$i]=="1")
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"hidden\" name=\"synEditable[$i]\" value=\"\"/><input type=\"checkbox\" name=\"synEditable[$i]\" value=\"1\" title=\"Is directly editable in the cell index?\" $chk/></td>\n";
          else
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"checkbox\"  disabled=\"disabled\" /></td>\n";
          ...
          if (isset($_SESSION["synChkMultilang"][$i]) and $_SESSION["synChkMultilang"][$i]=="1")
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"hidden\" name=\"synMultilang[$i]\" value=\"\"/><input type=\"checkbox\" name=\"synMultilang[$i]\" value=\"1\" title=\"Is multilanguage field?\" $chk/></td>\n";
          else
            echo "<td style='border-bottom: 1px solid #F2F2F2;'><input type=\"checkbox\"  disabled=\"disabled\" /></td>\n";
