...
FCKConfig.GoogleMaps_Key = 'ABQIAAAABoxpAD3E-mDPcIM1qdMJGxTudbhamiV9XUZoyhPuzs-jcS3q4RROakYVpfm31V5lhUqUM1UmW9nUHg' //kleis.eu
FCKConfig.GoogleMaps_CenterLat = '45.4577225021236';
FCKConfig.GoogleMaps_CenterLon = '11.063919067382812';
FCKConfig.GoogleMaps_Width = '429';
FCKConfig.GoogleMaps_Height = '275';

/*
    SEE: http://martinezdelizarrondo.com/googlemaps2/install.html
    ...
    * FCKConfig.KMLBrowserUrl : URL of the file browser for KML files. It defaults to LinkBrowserUrl. If it's an empty string the "Browse server" button won't be shown
    * FCKConfig.KMLBrowserWindowWidth and FCKConfig.KMLBrowserWindowHeight: Dimensions of the window for the KML file browser
...
FCKConfig.ToolbarSets["Default"] = [
  ...
  ['FontFormat','TextColor','BGColor'],
	['Image','Flash','Rule','SpecialChar','googlemaps']
] ;

FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','Link','Unlink','-','SelectAll','RemoveFormat','ShowBlocks','Source','-','About']
] ;

FCKConfig.ToolbarSets["Deluxe"] = [
	...
	['TextColor','BGColor','googlemaps'] 		// No comma for the last row.
] ;
